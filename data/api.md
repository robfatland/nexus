...
- This activity does not involve [***containerization***, a separate activity).](https://naclomi.github.io/containers-tutorial/) (see also the [containerization lecture notes](https://pythonbytes.azurewebsites.net/api/gargutron))
